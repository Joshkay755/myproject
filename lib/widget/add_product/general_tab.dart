              ...
              Row(
                ...
                children: [
                  InkWell(
                      ...
                      child: Text('Schedule', style: TextStyle(color: Colors.blue),)),
                  if(provider.productData!['scheduleDate']!=null)
                  Text(_services.formatedDate(provider.productData!['scheduleDate']))
                ],
              ),
              SizedBox(height: 30,),
  ...
  Widget build(BuildContext context) {
    ...
    return Dialog(
      child: FutureBuilder<QuerySnapshot>(
        future: service.mainCategories.where('category',isEqualTo:selectedCategory).get(),
...
class SubCategoryList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Dialog(
      child: FutureBuilder<QuerySnapshot>(
        future: service.subCategories.where('mainCategory',isEqualTo:selectedMainCategory).get(),
        builder: (context,snapshot){
          if(snapshot.connectionState==ConnectionState.waiting){
            return Center(child: CircularProgressIndicator(),);
          }
